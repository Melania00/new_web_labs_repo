...
// import { useRecoilDispatch } from 'recoil';
// import {addToCartAction, removeFromCartAction} from "../atom"

const Item = () => {
  const { id } = useParams();
  const [fridge] = useState(fridges.find((fridge) => fridge.id === +id));
  const [quantity, setQuantity] = useState(1); // Initial quantity set to 1
  // const dispatch = useRecoilDispatch();
      ...
      <div className="w-2/3 px-2">
        ...
        <div className="product-details">
          ...
          <div className="flex items-center mt-10">
            <label htmlFor="quantity" className="text-gray-700 font-bold mr-2">
              Quantity:
            </label>
            <select
              id="quantity"
